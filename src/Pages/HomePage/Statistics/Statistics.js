...
const Statistics = () => {
    return (
        <section className="p-6 py-20 my-6 bg-primary text-white dark:dark:bg-gray-800 dark:dark:text-gray-100">
	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
		<div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:dark:bg-gray-900 dark:dark:text-gray-100">
			<div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:dark:bg-sky-400">
