    ...
    <div className=" border-2 rounded-md shadow-md dark:dark:bg-gray-900 dark:dark:text-gray-100">
      ...
      <div className="flex flex-col justify-between p-6 space-y-8">
        <div className="space-y-2">
          <h2 className="text-2xl text-secondary font-semibold tracking-wide">
            {name}
          </h2>
          <p className="flex justify-between dark:dark:text-gray-100">
            {" "}
          ...
          <p className="flex justify-between dark:dark:text-gray-100">
            {" "}
            <span className="font-bold"> Used Time: {usageDuration}</span>{" "}
