...
const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-accent text-white dark:dark:bg-gray-800 dark:dark:text-gray-100">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            <Link to='/' className="self-center btn btn-ghost normal-case text-2xl font-semibold">
              Mobile Vision
            </Link>
          </Link>
        </div>
